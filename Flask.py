...
def welcome():
    return (
        ...
        "<li><b>/api/v1.0/map</b><br/>"
        "Map of all the circuits in Formula 1</li><br/>"
        "<li><b>/api/v1.0/charts</b><br/>"
